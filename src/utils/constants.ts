...
export const COLLATERAL_FSM__UPDATE_RESULTS_GAS = BigNumber.from('200000')
...
export const COLLATERAL_AUCTION_THROTTLER__RECOMPUTE_ON_AUCTION_SYSTEM_COIN_LIMIT_GAS = BigNumber.from(
  '500000'
)
